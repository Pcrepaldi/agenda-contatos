<?php
    ...
    switch($cod){
        case 0:
            echo "<div class='message contato message-sucess'>$mensagens[0]</div>";
            break;
        case 1:
            echo "<div class='message contato message-error'>$mensagens[1]</div>";
            break;
        case 2:
            echo "<div class='message contato message-error'>$mensagens[2]</div>";
            break;
        case 3:
            echo "<div class='message partida message-error'>$mensagens[3]</div>";
            break;
        default:
            break;
    }
