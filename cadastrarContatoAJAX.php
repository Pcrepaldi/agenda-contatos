...
?>
    <section>
            ...
            <form id="form-contato">
                <div class="campos">
                    ...
                    <div class="botoes">
                        ...
                        <input type="submit" form="form-contato" value="Novo" class="btn-default btn-sucess">
                    </div>
                </div>
                
            </form>
            <div id="mensagem" class='message contato message-sucess'></div>
        </div>
    </section>
        ...
        <script src="./assets/js/inserirContatoAJAX.js"></script>
